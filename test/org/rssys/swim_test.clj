...
(deftest new-node-object-test
  (testing "Create NodeObject instance is successful"
    (let [node-object (sut/new-node-object {:id   #uuid "00000000-0000-0000-0000-000000000001"
      ...
      (is (s/valid? ::spec/node (sut/value node-object)))

      (testing "Node object has correct structure"
        (match (sut/value node-object)
          {:id                   #uuid "00000000-0000-0000-0000-000000000001"
           :host                 "127.0.0.1"
           :port                 5376
           :cluster              cluster
...
;;            ping-event     (sut/ping-event node-object neighbour-id 1)]
...
;;          result (sut/ping-event node1 (.id node2) 1)]
;;
...
;;    (let [node1  (sut/new-node-object node-data1 cluster)
;;          node2  (sut/new-node-object node-data2 cluster)
;;          ping1  (sut/ping-event node1 (.id node2) 42)
;;          result (sut/ack-event node2 ping1)]
;;
...
;;          node2  (sut/new-node-object node-data2 cluster)
;;          ping1  (sut/ping-event node1 (.id node2) 42)
;;          result (sut/dead-event node2 ping1)]
;;
...
;;    (let [node1  (sut/new-node-object node-data1 cluster)
;;          node2  (sut/new-node-object node-data2 cluster)
;;          result (sut/probe-event node1 (.host node2) (.port node2))]
;;
...
;;    (let [node1           (sut/new-node-object node-data1 cluster)
;;          node2           (sut/new-node-object node-data2 cluster)
;;          probe-event     (sut/probe-event node1 (.host node2) (.port node2))
;;          probe-ack-event (sut/probe-ack-event node2 probe-event)]
;;
